        ...
        <div>
           <div id="about" className="mx-auto w-full lg:w-5/12 bg-rose-400 p-6 rounded-lg my-4">
            ...
            <p className="text-xs lg:text-xl text-gray-800"> Kindness is a blessing for thoose people who are not able to get all facilities.
                ...
                helps other in easy and effortable way. Keep with us and makes our jouenry easy. If you also want
                to help other, let us know:</p>
                <ul className="pt-3 text-xs lg:text-xl text-gray-800">
                    <li>☎️  +56975124</li>
                    <li>📧  kindnessofficial@gmail.com</li>
                    <li>🌐  www.kindness.gloval.com</li>
